...
void build_pyfcl(py::module &m_all) {
    ...
    PyTriangle.def(py::init())
            ...
            .def("set", [](Triangle &a, const int &p1, const int &p2, const int &p3) { a.set(p1, p2, p3); })
    ...
    // CollisionRequest
    auto PyCollisionRequest = py::class_<CollisionRequest, std::shared_ptr<CollisionRequest>>(m, "CollisionRequest");
    PyCollisionRequest.def(py::init<size_t, bool, size_t, bool, bool, GJKSolverType, DATATYPE>(),
                           ...
                           py::arg("gjk_solver_type") = GJKSolverType::GST_LIBCCD, py::arg("gjk_tolerance") = 1e-6)
            .def("isSatisfied", &CollisionRequest::isSatisfied, py::arg("result"));


    // DistanceRequest
    auto PyDistanceRequest = py::class_<DistanceRequest, std::shared_ptr<DistanceRequest>>(m, "DistanceRequest");
    PyDistanceRequest.def(py::init<bool, bool, DATATYPE, DATATYPE, DATATYPE, GJKSolverType>(),
                           py::arg("enable_nearest_points") = false, py::arg("enable_signed_distance") = false,
                           py::arg("rel_err") = 0.0, py::arg("abs_err") = 0.0,
                           py::arg("distance_tolerance") = 1e-6,
    ...
    auto PyDistanceResult = py::class_<DistanceResult, std::shared_ptr<DistanceResult>>(m, "DistanceResult");
    PyDistanceResult.def(py::init<DATATYPE>(), py::arg("min_distance")=std::numeric_limits<DATATYPE>::max())
    ...
    // CollisionResult
    auto PyCollisionResult = py::class_<CollisionResult, std::shared_ptr<CollisionResult>>(m, "CollisionResult");
    PyCollisionResult.def(py::init<>())
            .def("add_contact", &CollisionResult::addContact, py::arg("c"))
            .def("add_cost_source", &CollisionResult::addCostSource, py::arg("c"), py::arg("num_max_cost_sources"))
            ...
            .def("get_contacts", [](CollisionResult &a) {
                std::vector<Contact> contacts;
                a.getContacts(contacts);
                return contacts;
            })
            .def("get_cost_sources", [](CollisionResult &a) {
    ...
    auto PyCostSource = py::class_<CostSource, std::shared_ptr<CostSource>>(m, "CostSource");
    PyCostSource.def(py::init<>())
            .def(py::init<const Vector3 &, const Vector3 &, DATATYPE>(), py::arg("aabb_min"), py::arg("aabb_max"),
                 py::arg("cost_density"))
    ...
    auto PyContactPoint = py::class_<ContactPoint, std::shared_ptr<ContactPoint>>(m, "ContactPoint");
    PyContactPoint.def(py::init<>())
            .def(py::init<const Vector3 &, const Vector3 &, DATATYPE>(), py::arg("normal"), py::arg("pos"), py::arg("penetration_depth"))
    ...
    PyContact.def(py::init<>())
            .def(py::init<const CollisionGeometry *, const CollisionGeometry *, int, int>(), py::arg("o1"),
                 py::arg("o2"), py::arg("b1"), py::arg("b2"))
            .def(py::init<const CollisionGeometry *, const CollisionGeometry *, int, int, const Vector3 &, const Vector3 &, DATATYPE>(),
                 py::arg("o1"), py::arg("o2"), py::arg("b1"), py::arg("b2"), py::arg("pos"), py::arg("normal"),
                 py::arg("depth"))
    ...
    m.def("collide", [](const CollisionObject *o1, const CollisionObject *o2, const CollisionRequest &request) {
        CollisionResult result;
        fcl::collide(o1, o2, request, result);
        return result;
    })
    .def("distance", [](const CollisionObject *o1, const CollisionObject *o2, const DistanceRequest &request) {
    ...
    // Extra function
    m.def("load_mesh_as_BVH", load_mesh_as_BVH<DATATYPE>, py::arg("mesh_path"),py::arg("scale"));
    m.def("load_mesh_as_Convex", load_mesh_as_Convex<DATATYPE>, py::arg("mesh_path"),py::arg("scale"));
}
