...
class DemoSetup():
  ...
  def move_to_pose_with_RRTConnect(self, pose, use_point_cloud=True, use_attach=True, level=False):
  ...
  def move_to_pose(self, pose, with_screw=True, use_point_cloud=True, use_attach=True, level=False):
    if with_screw:
