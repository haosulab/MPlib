...
class ArticulatedModel:
    ...
    """
    def __init__(self, urdf_filename: str, srdf_filename: str, gravity: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]], joint_names: list[str], link_names: list[str], verbose: bool = True, convex: bool = False) -> None:
        """
        ...
        """
    def get_base_pose(self) -> numpy.ndarray[tuple[typing.Literal[7], typing.Literal[1]], numpy.dtype[numpy.float64]]:
        """
    ...
    def get_pinocchio_model(self) -> mplib.pymp.pinocchio.PinocchioModel:
        ...
        """
    def get_qpos(self) -> numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]]:
        """
    ...
    def get_user_link_names(self) -> list[str]:
        ...
        """
    def set_base_pose(self, pose: numpy.ndarray[tuple[typing.Literal[7], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None:
        """
    ...
    def set_move_group(self, end_effectors: list[str]) -> None:
        ...
        """
    def set_qpos(self, qpos: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]], full: bool = False) -> None:
        """
