...
class PinocchioModel():
    ...
    def compute_IK_CLIK(self, index: int, pose: numpy.ndarray[numpy.float64, _Shape[7, 1]], q_init: numpy.ndarray[numpy.float64, _Shape[m, 1]], eps: float = 1e-05, maxIter: int = 1000, dt: float = 0.1, damp: float = 1e-12) -> typing.Tuple[numpy.ndarray[numpy.float64, _Shape[m, 1]], bool, numpy.ndarray[numpy.float64, _Shape[6, 1]]]: ...
    def compute_IK_CLIK_JL(self, index: int, pose: numpy.ndarray[numpy.float64, _Shape[7, 1]], q_init: numpy.ndarray[numpy.float64, _Shape[m, 1]], q_min: numpy.ndarray[numpy.float64, _Shape[m, 1]], q_max: numpy.ndarray[numpy.float64, _Shape[m, 1]], eps: float = 1e-05, maxIter: int = 1000, dt: float = 0.1, damp: float = 1e-12) -> typing.Tuple[numpy.ndarray[numpy.float64, _Shape[m, 1]], bool, numpy.ndarray[numpy.float64, _Shape[6, 1]]]: ...
    ...
    def get_chain_joint_index(self, arg0: str) -> typing.List[int]: ...
    def get_chain_joint_name(self, arg0: str) -> typing.List[str]: ...
    ...
    def get_joint_limits(self, user: bool = True) -> typing.List[numpy.ndarray[numpy.float64, _Shape[m, n]]]: ...
    def get_joint_names(self, user: bool = True) -> typing.List[str]: ...
    def get_joint_types(self, user: bool = True) -> typing.List[str]: ...
    def get_leaf_links(self) -> typing.List[str]: ...
    def get_link_jacobian(self, index: int, local: bool = False) -> numpy.ndarray[numpy.float64, _Shape[6, n]]: ...
    def get_link_names(self, user: bool = True) -> typing.List[str]: ...
    ...
    def set_joint_order(self, names: typing.List[str]) -> None: ...
